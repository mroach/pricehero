...
# Create a group that will contain RSpec and Rubocop
# The `halt_on_fail` option will prevent Rubocopy from running when the
# spec fail. Code style isn't worth hearing about when the code is broken
